...
interpreter = tf.lite.Interpreter(model_path="./models/bird_classification/classify.tflite")
#interpreter = Interpreter(model_path="./models/Sample_TF_Lite_Model/detect.tflite")
