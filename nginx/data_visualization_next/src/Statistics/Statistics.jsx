...
function Statistics(props) {
  ...
  return (
    <div>
      <h1 style={{ textAlign: "center", marginBottom: "3px", color: "var(--mui-palette-primary-main, #2E7D5B)", fontWeight: 700, letterSpacing: "-0.01em" }}>Statistiken zu allen Stationen</h1>
      {data ? 
        <div>
