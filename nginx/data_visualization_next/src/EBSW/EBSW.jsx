  ...
  return (
    <div style={{ padding: "32px 4vw", maxWidth: 960, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        ...
        />
        <h1 style={{ color: "var(--mui-palette-primary-main, #2E7D5B)" }}>{lang.title}</h1>
      ...
      <div>
        ...
        {loading ? (
          ...
          <div>
            <Box sx={{ backgroundColor: "rgba(46,125,91,0.06)", border: "1px solid", borderColor: "divider", borderRadius: 2, p: 3, mb: 4 }}>
                ...
                <Grid size={{ xs: 6, sm: 3 }} key={item.label}>
                  <div
                    style={{
                      textAlign: "center",
                      padding: "16px 8px",
                      border: "2px solid var(--mui-palette-primary-main, #2E7D5B)",
                      borderRadius: 8,
                    }}
                  >
                    <div
                      style={{
                        fontSize: "2.2rem",
                        fontWeight: 700,
                        color: "var(--mui-palette-primary-main, #2E7D5B)",
                      }}
                    >
                      {item.value ?? 0}
                    </div>
